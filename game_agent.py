...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        return self.min_max_helper(game, depth)[0]

    def min_max_helper(self, game, depth):

        # helper function of minmax function
        ...
        for m in legal_moves:
            ...
            score = self.min_max_helper(next_move, depth - 1)[1]
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def min_helper(self, game, depth, alpha, beta):
        ...
        for m in legal_moves:
            ...
            score = self.max_helper(next_move, depth - 1, alpha, beta)
